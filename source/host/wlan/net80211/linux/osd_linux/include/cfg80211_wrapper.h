...
static struct ieee80211_channel obm_channels_5GHz[] = {
	...
	{ .hw_value = 52,  .center_freq = 5260, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 56,  .center_freq = 5280, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 60,  .center_freq = 5300, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 64,  .center_freq = 5320, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 100, .center_freq = 5500, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 104, .center_freq = 5520, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 108, .center_freq = 5540, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 112, .center_freq = 5560, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 116, .center_freq = 5580, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 120, .center_freq = 5600, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 124, .center_freq = 5620, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 128, .center_freq = 5640, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 132, .center_freq = 5660, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 136, .center_freq = 5680, .max_power = OBM_MAX_TXPWR },
	{ .hw_value = 140, .center_freq = 5700, .max_power = OBM_MAX_TXPWR },
...
int obm_remain_on_chan_cfg(struct net_device *ndev, int channel_num, uint32_t duration);
