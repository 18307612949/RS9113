...
typedef struct rsi_soc_gpio_vals_s {
	...
	uint32 PSPI_CSN_0 : 1;
	uint32 PSPI_CSN_1 : 1;
	uint32 host_wakeup_intr :1; 
	uint32 PSPI_DATA_0 : 1;
	uint32 PSPI_DATA_1 : 1;
	uint32 PSPI_DATA_2 : 1;
	uint32 PSPI_DATA_3 : 1;
	uint32 I2C_SCL :1  ;
	uint32 I2C_SDA   :1 ;             	
	uint32 UART1_RX :1;
	uint32 UART1_TX  :1;  
	uint32 UART1_RTS_I2S_CLK :1;
	uint32 UART1_CTS_I2S_WS :1;
	uint32 Debug_UART_RX_I2S_DIN :1;
	uint32 Debug_UART_TX_I2S_DOUT :1;
	uint32 LP_Wakeup_Boot_Bypass :1;
	uint32 LED_0 :1;
	uint32 BT_Coexistance_WLAN_ACTIVE_EXT_PA_ANT_SEL_A :1;
	uint32 BT_Coexistance_BT_PRIORITY_EXT_PA_ANT_SEL_B :1;
	uint32 BT_Coexistance_BT_ACTIVE_EXT_PA_ON_OFF :1;
	uint32 RF_reset :1;
	uint32 Sleep_indication_from_device :1;
...
typedef struct rsi_ulp_gpio_vals_s {
    uint8 Motion_sensor_GPIO_ULP_Wakeup : 1;
    uint8 Sleep_indication_from_device : 1;
    uint8 ULP_GPIO_2 :1;
    uint8 Push_Button_ULP_Wakeup : 1;
    uint8 reserved : 4;
...
ONEBOX_STATUS onebox_rf_loopback(PONEBOX_ADAPTER adapter,
                                             ...
                                             uint16 num_of_vals,
					     uint8 type);
ONEBOX_STATUS onebox_ant_sel(PONEBOX_ADAPTER adapter, uint8 value);
