 ...
 * @section DESCRIPTION
 *
 * The file contains the code to write contents to flash in RS9113.
 */
...
#ifdef SECTOR_MODE
	uint32 flash_chunk_size = FLASH_SECTOR_SIZE;
#else
	uint32 flash_chunk_size = FLASH_BLOCK_SIZE;
#endif
				     ...
				     )
{
	...
	uint32 flash_chunk_size = FLASH_WRITE_CHUNK_SIZE;
...
{         
	...
	//adapter->coex_osi_ops->onebox_dump(ONEBOX_ZONE_DEBUG, (PUCHAR)mgmt_frame, (FRAME_DESC_SZ + sizeof(BOOTUP_PARAMETERS)));
