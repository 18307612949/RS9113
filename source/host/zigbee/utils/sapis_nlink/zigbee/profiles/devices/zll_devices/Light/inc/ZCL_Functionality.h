...
#if(( g_COLOR_CONTROLLER_DEVICE_c == ENABLE) || (g_COLOR_SCENE_CONTROLLER_DEVICE_c == ENABLE)        \
|| ( g_NON_COLOR_CONTROLLER_DEVICE_c ==ENABLE ) || (g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c ==ENABLE) \
||(g_CONTROL_BRIDGE_DEVICE_c == ENABLE) || (g_ON_OFF_SENSOR_DEVICE_c == ENABLE))
...
#if( (g_COLOR_SCENE_CONTROLLER_DEVICE_c == ENABLE)        \
||  (g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c ==ENABLE) \
||(g_CONTROL_BRIDGE_DEVICE_c == ENABLE) || (g_ON_OFF_SENSOR_DEVICE_c == ENABLE))
...
#if((g_ON_OFF_LIGHT_DEVICE_c== ENABLE) || (g_ON_OFF_PLUG_IN_UNIT_DEVICE_c == ENABLE) \
||(g_DIMMABLE_LIGHT_DEVICE_c == ENABLE )||(g_DIMMABLE_PLUG_IN_UNIT_DEVICE_c == ENABLE)\
	||(g_COLOR_LIGHT_DEVICE_c == ENABLE)||(g_EXTENDED_COLOR_LIGHT_DEVICE_c == ENABLE)\
		||(g_COLOR_TEMPERATURE_LIGHT_DEVICE_c ==ENABLE))
#define g_IDENTIFY_SERVER_CLUSTER_ENABLE_d                           	1
#define g_ZLL_IDENTIFY_SERVER_CLUSTER_ENABLE_d                           1
#endif  /* eND of identify cluster*/

#if((g_DIMMABLE_LIGHT_DEVICE_c == ENABLE )||(g_DIMMABLE_PLUG_IN_UNIT_DEVICE_c == ENABLE)\
	||(g_COLOR_LIGHT_DEVICE_c == ENABLE)||(g_EXTENDED_COLOR_LIGHT_DEVICE_c == ENABLE)\
		||(g_COLOR_TEMPERATURE_LIGHT_DEVICE_c ==ENABLE) ||                                  \
(g_ON_OFF_LIGHT_DEVICE_c== ENABLE) || (g_ON_OFF_PLUG_IN_UNIT_DEVICE_c == ENABLE) )
...
#if( (g_COLOR_LIGHT_DEVICE_c == ENABLE)||(g_EXTENDED_COLOR_LIGHT_DEVICE_c == ENABLE)\
		||(g_COLOR_TEMPERATURE_LIGHT_DEVICE_c == ENABLE))
