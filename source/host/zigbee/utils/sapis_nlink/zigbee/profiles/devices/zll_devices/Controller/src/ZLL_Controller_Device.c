...
#if(g_COLOR_CONTROLLER_DEVICE_c == ENABLE)
...
#endif /* g_COLOR_CONTROLLER_DEVICE_c == ENABLE*/
...
#endif /* g_COLOR_SCENE_CONTROLLER_DEVICE_c == ENABLE*/
#if(g_NON_COLOR_CONTROLLER_DEVICE_c == ENABLE)
...
#endif /* g_NON_COLOR_CONTROLLER_DEVICE_c == ENABLE*/
#if(g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c == ENABLE)
...
#endif /*g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c == ENABLE */
#if( g_CONTROL_BRIDGE_DEVICE_c == ENABLE)
...
#endif /* g_CONTROL_BRIDGE_DEVICE_c == ENABLE*/
#if(g_ON_OFF_SENSOR_DEVICE_c == ENABLE)
...
#endif /* g_ON_OFF_SENSOR_DEVICE_c == ENABLE*/
	/* No more devices*/
	,{0xfe,0x00,g_NULL_c}
	,{0xfe,0x00,g_NULL_c}
	,{0xfe,0x00,g_NULL_c}
