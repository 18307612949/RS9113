...
#if(g_ON_OFF_LIGHT_DEVICE_c == ENABLE)
...
#endif /* g_ON_OFF_LIGHT_DEVICE_c == ENABLE*/
#if(g_ON_OFF_PLUG_IN_UNIT_DEVICE_c == ENABLE)
...
#endif /* g_ON_OFF_PLUG_IN_UNIT_DEVICE_c == ENABLE*/

#if(g_DIMMABLE_LIGHT_DEVICE_c == ENABLE)
    ,{ g_DIMMABLE_LIGHT_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Dimmable_Light )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Dimmable_Light }
#endif /* g_DIMMABLE_LIGHT_DEVICE_c == ENABLE*/

#if(g_DIMMABLE_PLUG_IN_UNIT_DEVICE_c == ENABLE)
...
#endif /* g_DIMMABLE_PLUG_IN_UNIT_DEVICE_c == ENABLE*/

#if(g_COLOR_LIGHT_DEVICE_c == ENABLE)
    ,{ g_COLOR_LIGHT_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Color_Light )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Color_Light }
#endif /* g_COLOR_LIGHT_DEVICE_c == ENABLE*/

#if(g_EXTENDED_COLOR_LIGHT_DEVICE_c == ENABLE)
...
#endif /* g_EXTENDED_COLOR_LIGHT_DEVICE_c == ENABLE*/

#if(g_COLOR_TEMPERATURE_LIGHT_DEVICE_c == ENABLE)
...
#endif /* g_COLOR_TEMPERATURE_LIGHT_DEVICE_c == ENABLE*/
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ){
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ){
			   ...
			   case g_Step_Color_Temperature_Event_c:
                   ...
                   App_Handle_Color_Control_Cluster_Events( &pActionHandler.event,p_buffer->dest_endpoint );
				   Send_Event_To_Application ( &pActionHandler.event );
                      break;
#endif              /* g_COLOR_CONTROL_SERVER_CLUSTER_ENABLE_d */
