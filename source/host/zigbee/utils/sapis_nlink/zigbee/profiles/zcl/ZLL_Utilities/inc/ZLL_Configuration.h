...
#define g_COLOR_CONTROLLER_DEVICE_c				DISABLE /* ENABLE or DISABLE*/
#define g_COLOR_SCENE_CONTROLLER_DEVICE_c		ENABLE /* ENABLE or DISABLE*/
#define g_NON_COLOR_CONTROLLER_DEVICE_c			DISABLE /* ENABLE or DISABLE*/
#define g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c	DISABLE /* ENABLE or DISABLE*/
#define g_CONTROL_BRIDGE_DEVICE_c				DISABLE /* ENABLE or DISABLE*/
#define g_ON_OFF_SENSOR_DEVICE_c				DISABLE /* ENABLE or DISABLE*/
...
#define g_ON_OFF_LIGHT_DEVICE_c					DISABLE /* ENABLE or DISABLE*/
#define g_ON_OFF_PLUG_IN_UNIT_DEVICE_c			DISABLE /* ENABLE or DISABLE*/
#define g_DIMMABLE_LIGHT_DEVICE_c				DISABLE /* ENABLE or DISABLE*/
#define g_DIMMABLE_PLUG_IN_UNIT_DEVICE_c		DISABLE /* ENABLE or DISABLE*/
#define g_COLOR_LIGHT_DEVICE_c					ENABLE /* ENABLE or DISABLE*/
#define g_EXTENDED_COLOR_LIGHT_DEVICE_c			DISABLE /* ENABLE or DISABLE*/
#define g_COLOR_TEMPERATURE_LIGHT_DEVICE_c		DISABLE /* ENABLE or DISABLE*/
