...
{
	gp_Color_Control_Cluster_Info = pZCLClusterInfo;
	gp_Color_Control_Attribute_Data_List = pAttrsDataBaseLocation;
#if ( g_COLOR_CONTROL_SERVER_CLUSTER_ENABLE_d == 1 )
...
//   /* Switching the command id values to check which command it is */
    ...
    ZCL_Read_Write_Attribute_Data(g_Write_Attribute_Data_c,pAttrsDataBaseLocation,pZCLClusterInfo,	
                                        g_COLOR_MODE_ATTRIBUTE_c,
					&color_mode_value);
