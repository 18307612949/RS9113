...
/*==============================================*/
/**
 * @fn           int32_t rsi_config_ipaddress(rsi_ip_version_t version, rsi_ip_config_mode_t mode, uint8_t *ip_addr, uint8_t *mask, uint8_t *gw, uint8_t *ipconfig_rsp, uint16_t length);
 ...
 */
int32_t  rsi_config_ipaddress(rsi_ip_version_t version, rsi_ip_config_mode_t mode, uint8_t *ip_addr, uint8_t *mask, uint8_t *gw, uint8_t *ipconfig_rsp, uint16_t length, uint8_t vap_id)
{
  rsi_pkt_t             *pkt;
 ...
 *              - RSI_WLAN_REQ_RSSI
 *              - RSI_WLAN_REQ_FW_VERSION
 *              - RSI_WLAN_REQ_MAC_ADDRESS
 * @param[in]   application buffer to get the command response payload
 * @param[in]   length of the application buffer to copy command response 
 * @param[out]  none
