...
typedef enum rsi_zigb_cmd_request_e
{
 ...
 ZIGBEELASTTYPE                         = 0x4A,
 APPSCANCOMPLETEHANDLER                 = (ZIGBEELASTTYPE + 1),						//0x4B
 APPENERGYSCANRESULTHANDLER             = (APPSCANCOMPLETEHANDLER+1),					//0x4C
 APPNETWORKFOUNDHANDLER                 = (APPENERGYSCANRESULTHANDLER+1),				//0x4D
 APPZIGBEESTACKSTATUSHANDLER            = (APPNETWORKFOUNDHANDLER +1),					//0x4E
 ZIGBEECHILDJOINHANDLER                 = (APPZIGBEESTACKSTATUSHANDLER+1),				//0x4F
 APPCHILDJOINHANDLER                    = ZIGBEECHILDJOINHANDLER,					//0x4F
 APPINCOMINGMANYTOONEROUTEREQUESTHANDLER= (ZIGBEECHILDJOINHANDLER + 1),					//0x50
 APPHANDLEDATAINDICATION                = (APPINCOMINGMANYTOONEROUTEREQUESTHANDLER + 1),		//0x51
 APPHANDLEDATACONFIRMATION              = (APPHANDLEDATAINDICATION + 1),				//0x52
 APPHANDLEINTERPANDATAINDDICATION				=	(APPHANDLEDATACONFIRMATION + 1),//0x53
 APPHANDLEINTERPANDATACONFIRMATION			=	(APPHANDLEINTERPANDATAINDDICATION + 1),	//0x54
...
typedef void (*rsi_zigb_zdp_app_response_handler_t)(uint8_t bufferIndex);
#ifdef ZB_PROFILE
